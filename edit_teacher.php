...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conn->query("UPDATE teachers SET name='$name', expertise='$expertise' WHERE id = $id");
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(120deg,rgb(39, 202, 93), #e2e2e2);
            padding: 20px;
            color: #333;
        }
...
<body>
    ...
    <form method="POST">
        ...
        <input type="text" id="expertise" name="expertise" value="<?php echo $teacher['expertise']; ?>" required>
        <button type="submit">Update</button>
    </form>
    <nav>
        <a href="list_teachers.php">&#8592; Kembali ke Daftar Pelajar</a>
    </nav>
</body>
</html>